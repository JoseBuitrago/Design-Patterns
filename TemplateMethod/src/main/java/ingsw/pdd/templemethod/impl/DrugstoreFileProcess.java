package ingsw.pdd.templemethod.impl;

import java.io.File;
import java.io.FileInputStream;
import java.io.FileOutputStream;
import ingsw.pdd.templemethod.util.OnMemoryDataBase;
...
public class DrugstoreFileProcess extends AbstractFileProcessTemplate {
    ...
    protected void validateName() throws Exception {
        ...
        if (!fileName.endsWith(".drug")) {
            throw new Exception("Nombre el archivo no válido" + ", debe terminar con .drug");
        }

package ingsw.pdd.templemethod;

import java.io.File;
import java.util.Date;
import java.util.Timer;
import java.util.TimerTask;
import ingsw.pdd.templemethod.impl.DrugstoreFileProcess;
import ingsw.pdd.templemethod.impl.GroceryFileProcess;
...
public class TemplateMethodMain extends TimerTask {
    ...
    public void run() {
        ...
        for (File file : groceryFiles) {
            try {
                System.out.println("> File found > " + file.getName());
                new ingsw.pdd.templemethod.impl.GroceryFileProcess(file,LOG_DIR,PROCESS_DIR).execute();
